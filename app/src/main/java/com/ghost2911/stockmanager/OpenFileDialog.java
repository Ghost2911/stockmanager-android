...
public class OpenFileDialog extends AlertDialog.Builder {
    ...
    private Drawable folderIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_folder_row);
    private Drawable fileIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_file);
